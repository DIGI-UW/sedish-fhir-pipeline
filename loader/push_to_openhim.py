...
CLINICAL_VIEWS = [v.strip() for v in env("CLINICAL_VIEWS", "encounter,visit,observation,allergy_intolerance,condition,medication_request,immunization").split(",") if v.strip()]
